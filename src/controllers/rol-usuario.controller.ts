...
export class RolUsuarioController {
  ...
  async find(
    ...
    return this.rolRepository.ta_asociado(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.ta_asociado(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.ta_asociado(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.ta_asociado(id).delete(where);
  }
}
