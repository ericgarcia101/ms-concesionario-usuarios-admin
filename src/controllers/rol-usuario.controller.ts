...
export class RolUsuarioController {
  ...
  async find(
    ...
    return this.rolRepository.ta_asociado(_id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.ta_asociado(_id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.ta_asociado(_id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.ta_asociado(_id).delete(where);
  }
}
